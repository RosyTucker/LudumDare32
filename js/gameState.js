...
GameState = function(game) {
    ...
    this.preload = function () {
        game.load.image('sink', 'assets/sink.png');
        game.load.image('bin', 'assets/bin.png');
        game.load.image('cabinet2', 'assets/cabinet2.png');
        game.load.image('fridge', 'assets/fridge.png');
        game.load.image('drainingBoard', 'assets/drainingBoard.png');
        game.load.image('cabinet', 'assets/cabinet.png');
        game.load.image('cabinet3', 'assets/cabinet3.png');
        game.load.atlas('player', 'assets/player/player.png', 'assets/player/player.json');
        game.load.image('logo', 'assets/logo.png');
        game.load.image('oven', 'assets/oven.png');
        game.load.image('toast', 'assets/toast.png');
        game.load.image('broccoli', 'assets/broccoli.png');
        game.load.image('explosion', 'assets/jamExplosion.png');
        game.load.image('enemy', 'assets/fryingPan.png');
        game.load.image('ground', 'assets/ground.png');
        game.load.audio('splodge', 'assets/sounds/splodge.m4a');
        game.load.audio('fire', 'assets/sounds/fire.m4a');
        game.load.audio('shuffle', 'assets/sounds/shuffle.m4a');
        game.load.audio('hit', 'assets/sounds/hit.m4a');
        game.load.audio('music', 'assets/sounds/music.m4a');
    };
